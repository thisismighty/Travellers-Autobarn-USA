		...
		<div class="col-xs-4 panel1">
			<ul class="info-table">
				<li>
					<h3>TAB Benefits</h3>
					<ul class="small">
						<li>10% Discount on all caravan parks</li>
						<li><a href="/wp-content/uploads/2014/03/rental.pdf">TAB Drive Guide - exclusive access to our partner network</a></li>
						<li>Booklet with free camp site</li>
					</ul>
				</li>
			</ul>
		</div>
...
<?php } ?>
	...
	<h4>All vehicles come with:</h4>
	<ul class="two-columns">
		<li>Unlimited kilometers</li>
		<li>24/7 Roadside assistance</li>
		<li>Toll-free service number</li>
		<li>Free road atlas</li>
	</ul>
	...
	<div style="width:100%;text-align:center;">
		<a class="btn-large" href="/quick-quote">Quick Quote</a>
		<a class="btn-large" href="/campervan-and-car-rental/rental-booking-and-enquiry-form/">Email Us</a>
