<?php
	/*
	Template Name: Home Page MIGHTY TEST
	*/
...
.section.buy .why-buy .why-buy-box .btn.btn-default{ font-size: 28px; padding: 10px 0; }
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-5 hidden-xs special-deals-box padding">
                ...
                <a href="/car-deals-and-campervan-specials/"><img src="<?php echo get_site_url();?>/wp-content/themes/travellers-autobarn/assets/images/general/special-offers-img.png" class="btn-alignright-less-margin alignright img-responsive" /></a>

				<a href="<?php the_field('customer_reviews');?>" class="btn btn-default alignright btn-alignright-less-margin">Customer Reviews</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8  col-sm-7 padding bg-yellow">
                ...
                ?>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-4 range <?php echo $hide;?>">
                    <div class="item">
            ...
            <div class="col-lg-4 col-md-4 col-sm-5 why-hire hidden-xs padding">
                <div class="why-hire-box">
                    ...
                    <?php 
                        if(get_field('why_hire_from_us_link', 'option') !=""):                       
                            echo '<a href="'.get_field('why_hire_from_us_link', 'option').'" class="btn btn-default">View our Vehicles</a>';
                        endif;
                    ?>
                </div> <!-- why-hire-box -->
            </div> <!-- why-hire -->
...
<style>
  ...
  .owl-carousel, .booking-form { display: none; } /* DELETE this line before going live */
  .mighty-reviews { overflow: hidden; }
  .mighty-reviews hr { margin: 20px 0; }
  
  .grw-slider .grw-slider-prev,
  .grw-slider .grw-slider-next {
    background-image: url('http://www.travellers-autobarn.co.nz/wp-content/uploads/2017/12/chevron.png');
  ...
  <div class="container">      
    <div class="row gr-container">
      <div class="col-xs-12">
        ...
        <hr>
        <a target="_blank" href="https://goo.gl/maps/hvm1RYKrUSn" class="gr-more-reviews-button"><img class="gr-more-reviews-button-img" alt="More Reviews on Google" src="http://www.travellers-autobarn.co.nz/wp-content/uploads/2017/12/more-reviews-on-google.png"></a>
      </div>
    </div>
        ...
        <div class="row">
			...
			<div class="col-lg-4 col-md-4  hidden-sm social-media-cols">
				...
				<div class="social-box">
					...
					<?php foreach(instagram() as $v):?>
						
						<a class="no-border" onclick="popup('<?=$v['link']?>', 'SnapWidget', '1024', '720', 'yes');" href="javascript:void(0)">
							<img src="<?=$v['image']?>" alt="" class="instagram-img"/>
						</a>
					<?php endforeach;?>
				</div>
			</div>
