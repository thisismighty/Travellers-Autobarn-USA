			...
			<div class="col-lg-5 col-md-5 col-sm-12 links">       
				<div class="contact row">
					<?php /*<ul>
						...
						<a href="<?php the_field('roadtrip_link', 'option');?>" rel="nofollow" target="_blank" class="btn btn-default">
							<?php the_field('view_roadtrips', 'option');?>
						</a>
