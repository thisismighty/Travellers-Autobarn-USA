<?php
$mobile_menu=wp_get_nav_menu_items('Main Menu (Mobile)');
$mobile_base=array();
...
<!-- AddThis Button END --> 
                ...
                <a href="<?php the_field('instagram_link', 'option');?>" target="_blank" rel="nofollow"><img
		style="width:25px;" class="icon-instagram"
		src="<?php echo get_template_directory_uri();  ?>/assets/images/icons/instagram.png" /></a>
                <div class="our-blog"><a href="<?php the_field('blog_link', 'option');?>" target="_blank" rel="nofollow"><i class="icon-comment"></i> <span class="hidden-sm"><?php the_field('our_blog', 'option');?></span></a></div>
            </li>
...
var EMMenu={
	...
	toggleMenu:function(){
		...
		$('#mobile-hamburger').slideDown();
		$('#mobile-menu .hamburger').addClass('open');
	},
	resize:function(){
...
$(window).on('resize',function(){EMMenu.close();});
</script>
